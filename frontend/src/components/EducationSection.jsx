...
import { GraduationCap, Award, BookOpen, Cpu, Calendar, MapPin, CheckCircle2 } from 'lucide-react';
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <h2 style={{ fontSize: '2.4rem', fontWeight: 800, color: '#ffffff', letterSpacing: '-0.5px' }}>
            Academic Foundation & Qualifications
          </h2>
          <p style={{ color: '#94a3b8', fontSize: '0.95rem', maxWidth: '600px', margin: '0.4rem auto 0 auto' }}>
            Degree details, academic performance marks, core Computer Science coursework, and technical training.
          </p>
        </div>
